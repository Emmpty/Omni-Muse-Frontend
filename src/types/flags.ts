...
const featureFlags = createFeatureFlags({
  ...
  air: {
    ...
    description: `Show the Omnimuse AIR on resources for easy use within the Omnimuse Services API or Omnimuse Comfy Nodes.`,
    availability: ['user'],
  },
  modelCardV2: {
    toggleable: true,
...
export const getFeatureFlags = ({ user }: { user?: TUserProps }) => {
...
export const hasFeature = (key: FeatureFlagKey, user?: TUserProps) => {
