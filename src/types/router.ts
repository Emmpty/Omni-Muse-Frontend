...
export type RouterOutput = inferRouterOutputs<any>;
...
type DataSetRouter = RouterOutput['bounty'];
export type DataSetGetAll = DataSetRouter['getInfinite']['items'];
export type DataSetGetById = DataSetRouter['getById'];
export type DataSetGetEntries = DataSetRouter['getEntries'];
