...
export function GeneratedImage({
  ...
  const handleThumbsDownClick = () => {
    openGenQualityFeedbackModal({
      jobId: image.hash,
      onSubmit: () => setSelectedFeedback(any.BAD),
  ...
  const badFeedbackSelected = selectedFeedback === any.BAD;
  const goodFeedbackSelected = selectedFeedback === any.GOOD;
                    ...
                    <ActionIcon
                      ...
                      onClick={
                        !goodFeedbackSelected
                          ? () => handleSendFeedback({ quality: any.GOOD })
                          : undefined
                      }
                    >
                      <IconThumbUp size={16} />
