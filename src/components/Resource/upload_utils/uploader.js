import { MAX_REQUEST_NUM, MAX_RETRY_NUM } from './config.js';
import { ajax4Upload, ajax } from './request.js';
import { createFileChunk, calculateFileHash } from './util.js';
...
export default class Uploader {
  ...
  verifyHash(fileSize, contentHash) {
    ...
    return ajax({
      // url: VERIFY_FILE_API,
      url: 'https://app.omnimuse.ai/6062/file/prepare',
      data: formData,
    });
  }
