...
import { IconHeart, IconMoodSmile, IconPhoto, IconPlus } from '@tabler/icons-react';
...
type ReactionsProps = Omit<any, 'reaction'> & {
  reactions: { userId: number; reaction: ReviewReactions }[];
  metrics?: ReactionMetrics;
  readonly?: boolean;
};

const availableReactions: Partial<Record<any['entityType'], ReviewReactions[]>> = {
