...
import { ArticleSort, CollectionSort, ImageSort, PostSort } from './enums';
...
export const TOURNAMENTS_SEARCH_INDEX = 'tournaments_v2';
...
export const modelVersionMonetizationTypeOptions: Record<ModelVersionMonetizationType, string> = {
  ...
  [ModelVersionMonetizationType.CivitaiClubOnly]: 'Exclusive to Omnimuse Club members',
